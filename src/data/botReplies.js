export const BOT_REPLIES = [
  ...
  { match: /imam|himayat/i, reply: "Imam Pasand (Himayat) is royalty among mangoes 🔴 — an elegant, delicate variety from Telangana with melting texture and rich, nuanced sweetness. $85/box. Season: May–Jun." },
  { match: /price|cost|how much|cheapest|expensive/i, reply: "Our varieties range from $68 to $89 per box — all air-flown fresh from India! 🥭\n\n🍋 Chandura — $68\n🍋 Banganapalli — $70\n🟡 Mallika — $72\n🔴 Imam Pasand — $85\n🥭 Alphonso — $89\n\nFree delivery on orders over $120!" },
  ...
  { match: /whatsapp|wa|chat|message/i, reply: "You can reach us instantly on WhatsApp at +65 9155 5947 — we typically respond within a few minutes during business hours (Mon–Sat, 9am–6pm SGT). 💬" },
...
export function getBotReply(text) {
  ...
  return "Great question! 🥭 For the most accurate answer, feel free to reach us at info@gardenroots.com.sg or call +65 9155 5947 (Mon–Sat, 9am–6pm SGT). We're happy to help!";
}
